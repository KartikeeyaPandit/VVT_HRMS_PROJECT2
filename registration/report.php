	...
	<div class="container" style="background-color:black;">
		<div class="register-box">
		  	<div class="register-logo">
		    	<a href="<?php echo BASE_URL; ?>reports/<?php echo $empDATA['emp_code']; ?>/"><b style="color:white; text-shadow:2px 2px red;">HRM System</b></a><br>
		    	<small style="color:white;"><b>Employee Code: <?php echo $empDATA['emp_code']; ?></b></small>
		  	</div>
		</div>
		<div class="box box-primary" style="background-color:#c4c4c4;">
			...
			<div class="box-footer" style="background-color:black;">
