	...
	<div class="container" style="background-color:black;">
		<div class="register-box">
		  	<div class="register-logo" style="color:white;">
		    	...
		    	<a href="<?php echo BASE_URL; ?>" style="color:white; text-shadow:2px 2px red;"><b>HRM System</a><br>
		    	<small style="text-shadow:2px 2px red;">Employee Registration Form</small>
		  	</div>
		</div>
		<div class="box box-primary" style="background-color:#c4c4c4;">
			<div class="box-header with-border">
				<h3 class="box-title">Fill the below form to register</h3>
