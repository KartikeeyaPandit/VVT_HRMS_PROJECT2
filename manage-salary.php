...
<head>
	...
	<title>Salary for <?php echo $month; ?></title>
...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content" style="background-color:#c4c4c4;">
				<div class="row">
        			<div class="col-xs-12">
						<div class="box">
							<div class="box-body">
									...
									<form method="POST" role="form" id="payslip-form">
										...
										<div class="row">
											...
											<div class="col-sm-6 text-right">
												<?php if ( !empty($empHeads) ) { ?>
													<button type="submit" class="btn btn-info" onclick="window.print();">
													 	<i class="fa fa-plus"></i> Print PaySlip
													</button>
												<?php } ?>
											</div>
										</div>
		...
		<strong><center>HRM System &copy; <?php echo date("Y");?> </center>  </strong> 
		</footer>
	</div>
