...
<aside class="main-sidebar" style="background-color:black;">
	<section class="sidebar">
		<div class="user-panel" style="border:1px solid white;">
		...
		<ul class="sidebar-menu" >
			<!--<li class="header" style="background-color:black;">NAVIGATION</li>-->
			<?php if ( $_SESSION['Login_Type'] == 'admin' ) { ?>
				<li class="<?php echo $page_name == "attendance" ? 'active' : ''; ?>" >
					<a href="<?php echo BASE_URL; ?>attendance/">
						<i class="fa fa-calendar" ></i> <span style="color:yellow;">Attendance</span>
					</a>
				</li>
				<li class="<?php echo $page_name == "employees" ? 'active' : ''; ?>">
					<a href="<?php echo BASE_URL; ?>employees/">
						<i class="fa fa-users"></i> <span style="color:yellow;">Employees Section</span>
					</a>
				</li>
				<li class="<?php echo $page_name == "salaries" ? 'active' : ''; ?>">
					<a href="<?php echo BASE_URL; ?>salaries/">
						<i class="fa fa-money"></i> <span style="color:yellow;">Salary Slips</span>
					</a>
				</li>
				<li class="<?php echo $page_name == "leaves" ? 'active' : ''; ?>">
					<a href="<?php echo BASE_URL; ?>leaves/">
						<i class="fa fa-sign-out"></i> <span style="color:yellow;">Leave Management</span>
					</a>
				</li>
				<li></li>
				<li class="<?php echo $page_name == "payheads" ? 'active' : ''; ?>">
					<a href="<?php echo BASE_URL; ?>payheads/">
						<i class="fa fa-gratipay"></i><span style="color:yellow;"> Pay Heads</span>
					</a>
				</li>
				<li class="<?php echo $page_name == "holidays" ? 'active' : ''; ?>">
					<a href="<?php echo BASE_URL; ?>holidays/">
						<i class="fa fa-calendar-check-o"></i> <span style="color:yellow;"> List Holidays</span>
					</a>
				</li>
			<?php } else { ?>
				<!--<li class="<?php echo $page_name == "salaries" ? 'active' : ''; ?>">
