<header class="main-header">
	<a href="<?php echo BASE_URL; ?>" class="logo" style="background-color:black;">
	...
	<nav class="navbar navbar-static-top" role="navigation" style="background-color:black;">
		...
		<span class="logo-lg" style="color:yellow; font-size:30px; text-shadow:2px 2px red;"><b>HRM System</b></span>
				...
				<li class="dropdown user user-menu">
					...
					<ul class="dropdown-menu" >
						...
						<li class="user-footer">
							<div class="pull-left">
								<a href="<?php echo BASE_URL; ?>profile/" class="btn btn-warning ">Profile</a>
							</div>
